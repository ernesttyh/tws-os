...
import { Search, LayoutDashboard, Settings, ChevronDown, ChevronRight, X } from 'lucide-react'
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 z-50 w-64 flex flex-col border-r overflow-hidden
      ...
      `}
        ...
        <div className="p-4 border-b flex items-center justify-between" style={{ borderColor: 'var(--border)' }}>
          ...
          {onClose && (
            <button 
              onClick={onClose} 
              className="lg:hidden p-1.5 rounded-lg hover:bg-[var(--bg-hover)] transition"
